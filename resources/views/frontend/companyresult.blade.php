    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 links" style="margin-top: 30px !important;">
                ...
                <h3><a href="#" class="link-item hidden" data-option="2">COMPANY</a></h3>
            </div>
        </div>
        <div id="login" class="col-md-8 col-md-offset-2" style="margin-top: 30px !important;">
            ...
            <form class="row" method="get" action="{{ route('companyresult') }}" data-item="2">
            ...
            <div class="row">
                @if(count($result) == 0)
                    <div class="col-md-12 col-sm-12 col-xs-12 result-body">
                        ...
                        <h4 class="text-center" style="color:green;padding-bottom:50px">{{ $company }} has no credit record</h4>
                    </div>
                @else
                    <div class="col-md-12 col-sm-12 col-xs-12 result-body">
                            ...
                            <tbody>
                                @foreach($result as $result)
                                    <tr class="table-row">
                                        ...
                                        <td class="table-text">
                                            <h4 class="text-left"> {{$result->company_name}}</h4>
            ...
            <div class="profile-bottom">
                <div class="profile-bottom-top">
                    ...
                    <div class="col-md-8 profile-text">
                        <h3 id="company">Firstname Lastname</h3>
